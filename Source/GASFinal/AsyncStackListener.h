...
#include "AsyncStackListener.generated.h"
 ...
 */
UCLASS()
class GASFINAL_API UAsyncStackListener : public UBlueprintAsyncActionBase
{
	GENERATED_BODY()
	...
	UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"))
		static UAsyncStackListener* ListenForGameplayEffectStackChange(UAbilitySystemComponent* AbilitySystemComponent, FGameplayTag EffectGameplayTag);
