...
#include "PlayMontageAndWaitEvent.generated.h"
...
UCLASS()
class GASFINAL_API UPlayMontageAndWaitEvent : public UAbilityTask
{
	GENERATED_BODY()
...
public:
	...
	UPlayMontageAndWaitEvent(const FObjectInitializer& ObjectInitializer);
	...
	*/
	...
	UFUNCTION(BlueprintCallable, Category = "Ability|Tasks", meta = (HidePin = "OwningAbility", DefaultToSelf = "OwningAbility", BlueprintInternalUseOnly = "TRUE"))
		static UPlayMontageAndWaitEvent* PlayMontageAndWaitForEvent(
